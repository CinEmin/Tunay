...
GO
/*
The type for column ProductQuantity in table [dbo].[Product] is currently  VARCHAR (50) NOT NULL but is being changed to  INT NOT NULL. Data loss could occur.
*/
...
GO
ALTER TABLE [dbo].[Product] ALTER COLUMN [ProductQuantity] INT NOT NULL;


GO
PRINT N'Refreshing [dbo].[FullProductInfo]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[FullProductInfo]';
